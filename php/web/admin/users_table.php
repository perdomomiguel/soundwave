...
if (isset($_POST["delete"])) {
    echo delete_user($conn, $id_cliente);
}
...
<head>
    ...
    <title>Soundwave | Tabla Usuarios</title>
...
<nav class="navbar navbar-dark">
        <div class="nav-section1">
             <a href="admin_home.php"><img class="logo" src="../../../img/logo/logo.png" alt=""></a>
        </div>
...
if (isset($_SESSION["nombre"]) && isset($_SESSION["id_cliente"])) {
    echo users_table($conn, $id_cliente);
}
