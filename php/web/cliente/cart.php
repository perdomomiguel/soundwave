...
if (isset($_POST["delete"])) {
    ...
    echo delete_from_cart($conn, $id_cliente, $id_producto);
}

// Verificar si se ha enviado el formulario para comprar un producto
if (isset($_POST["buy"])) {
...
if (isset($_SESSION["nombre"]) && isset($_SESSION["id_cliente"])) {
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            // Generar una fila en la tabla para cada producto en el carrito
            echo "<tr class='producto'>
                ...
                <form method='POST'>
                    ...
                    <td class='eliminar'><button name='delete' class='eliminar-carrito'>ELIMINAR DEL CARRITO</button></td>
                    <td class='comprar-tabla'><button name='buy' class='comprar-carrito'>COMPRAR</button></td>
                </form>
            </tr>";
        }
        echo "</tbody></table></main>";
    } else {
        echo "<h1 class='session-message'>No hay productos en el carrito</h1>";
    }
